...
set label 2 at graph 0.50, 0.90 sprintf("{/*0.75 (logarithmische Darstellung; Datenquelle: Robert Koch-Institut; Datenstand: %s)}", last_update_rki) center textcolor ls 0
...
set label 2 at graph 0.50, 0.90 sprintf("{/*0.75 (logarithmic graph; data source: Robert Koch Institute; last update: %s)}", last_update_rki) center textcolor ls 0
