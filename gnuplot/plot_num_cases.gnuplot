...
set label 2 at graph 0.50, 0.90 sprintf("{/*0.75 (Quelle: Robert Koch-Institut; Datenstand: %s)}", last_update_rki) center textcolor ls 0
...
plot  \
  ...
  \
  "../data/RKI_Monkeypox.csv" using 1:($3>0?$3:1/0):(sprintf("{/*0.75 %d}", $3)) with labels point ls 2 ps 0.0 center offset char -0.5, 0.75 tc "#0000FF" notitle
...
set label 2 at graph 0.50, 0.90 sprintf("{/*0.75 (source: Robert Koch Institute; last update: %s)}", last_update_rki) center textcolor ls 0
